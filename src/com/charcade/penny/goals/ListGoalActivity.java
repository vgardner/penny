...
public class ListGoalActivity extends BaseActivity {
  
	public ListGoalActivity() {
...
/** Called when the activity is first created. */
  ...
  public void populateHabitList(){
    ...
    listView.setAdapter(new GoalListAdapter(this, R.layout.habit_list_row, habitList));
  }
}
